...
function EdgeDetection() {
  ...
  console.log("create EdgeDetection");
  ...
  const onMounted = function() {
    ...
    u_EdgeMat3 = glContext.getUniformLocation(renderShaderProgram, 'u_EdgeMat3');
  ...
  const drawScene = function() {
    ...
    glContext.uniformMatrix3fv(u_EdgeMat3, false, edgeMat3);
